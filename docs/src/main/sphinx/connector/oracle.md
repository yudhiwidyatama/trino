...
* - `index`
  - No
  - List of index definitions to create on the table. Each entry specifies an index definition with the format `index_name(column1, column2, ...)`. Supported for both `CREATE TABLE` and `CREATE TABLE AS`.
:::
